    ...
    <div class="wrap-slick1">
        <div class="slick1">
            ...
            <div class="item-slick1"
                style="background-image: url('https://img.pikbest.com/origin/10/01/82/867pIkbEsTAIq.png!sw800');">
            </div>

            {{-- Slide 2 --}}
            <div class="item-slick1"
                style="background-image: url('https://t4.ftcdn.net/jpg/02/49/50/15/360_F_249501541_XmWdfAfUbWAvGxBwAM0ba2aYT36ntlpH.jpg');">
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ $product->images->first()->image_url ?? 'images/default.png' }}"
