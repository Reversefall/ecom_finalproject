                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="blog-img position-relative">
                                                ...
                                                <img src="{{ asset($group->product->images->first()->image_url) }}" alt="{{ $group->group_name }}" class="bg_img" />
                                                @else
                                                <img src="{{ asset('assets_admin/vendors/images/default-product.png') }}" alt="No image" class="bg_img" />
                                                @endif
                                            ...
                                            <div class="blog-caption">
                                                ...
                                                <div class="blog-by">
                                                    ...
                                                    <div class="pt-10">
                                                        ...
                                                        <a href="{{ url('/user/groups/chat/'.$group->group_id) }}" class="btn btn-outline-success">Chat</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
